  ...
  const products = [
    {
      ...
      price: "9,900원",
      image:
        "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=800&auto=format&fit=crop", // 책 이미지
    },
    {
      id: 2,
      title: "실물책",
      ...
      price: "14,900원",
      image:
        "https://images.unsplash.com/photo-1589829085413-56de8ae18c73?q=80&w=800&auto=format&fit=crop", // 다른 책 이미지
    },
  ];
          ...
          <Link href={`/shop/books/${product.id}`} key={product.id}>
            <div className="flex flex-col gap-4 group cursor-pointer">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-gray-600 font-medium text-lg">{product.description}</p>
