...
import { useMyLectures } from "@/hooks/useLecture";
import LoadingSpinner from "@/components/LoadingSpinner";

export default function OngoingPage() {
  const { lectures, loading } = useMyLectures();
              ...
              <div className="flex flex-col gap-4 group cursor-pointer">
                <div className="relative overflow-hidden rounded-2xl w-full aspect-[750/450] bg-zinc-800 border border-white/5">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 h-2 bg-gray-800">
                    <div className="h-full bg-purple-500" style={{ width: `${lecture.progress}%` }} />
                  </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2 text-gray-400 text-sm font-medium">
                    ...
                    <span className="w-1 h-1 rounded-full bg-gray-500" />
                    <span className="text-purple-500">{lecture.progress}% 완료</span>
                  </div>
                </div>
              </div>
            </Link>
